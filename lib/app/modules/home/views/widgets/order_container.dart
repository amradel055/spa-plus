...
class OrderContainer extends GetView<HomeController> {
  const OrderContainer(this.showDetails, this.num, this.carName, this.groupName, this.date,  this.road,this.remark, this.time, this.name, this.phone, this.address, this.i, this.start, this.end,  {Key? key}) : super(key: key);
                ...
                child: Row(
                  children: [
                        ...
                        children: [
                          SizedBox(width: double.infinity,
                            child: Column(
                              ...
                              children: [
                                TextWidget(name,textColor: AppColors.appBlue,weight: FontWeight.bold,size: 15,),
                                Row(
                                  children: [
                                    ...
                                    GestureDetector(
                                        ...
                                        child: TextWidget(phone,textColor: AppColors.appBlue,weight: FontWeight.bold,size: 13,)),
                          ...
                          Row(
                            children: [
                              TextWidget(carName.toString(),textColor: AppColors.appBlue,weight: FontWeight.bold,size: 13,)
                              ,TextWidget("($groupName)",textColor: AppColors.appBlue,weight: FontWeight.bold,size: 13,)

                            ],
                          ),
                          Row(
                            children: [
                              TextWidget(DateFormat('yyyy.MM.dd').format(
                                  date
                              ),textColor: AppColors.appBlue,weight: FontWeight.bold,size: 13,)
                              ,TextWidget(DateFormat('HH:MM ').format(
                                  time
                              ).toString(),textColor: AppColors.appBlue,weight: FontWeight.bold,size: 13,)
                          ...
                          SizedBox(width: double.infinity,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const TextWidget("الملاحظات",textColor: AppColors.appBlue,weight: FontWeight.bold,size: 13,)
                                ,TextWidget(remark,textColor: AppColors.appBlue,weight: FontWeight.bold,size: 13,maxLines: 100,),
                    ...
                    showDetails ?   GestureDetector(
                      onTap: (){
                        controller.index.value == 0 ?controller.getDeliver(controller.activeOrders[i].id!, UserManager().user!.id):controller.getFinishDeliver(controller.deliverdOrders[i].id!);
