    ...
    return Scaffold(
        ...
        body: ListView(
            ...
            children: [
              ...
              const TextWidget(
                'الاضافات الخاصة بالقاعة', weight: FontWeight.bold, size: 20,),
              SizedBox(
                height: size.height * 0.7,
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    for(AdditionsGroupModel add in controller.hall
                      ...
                      Container(width: size.width * .9,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ,
                            const TextWidget(
                              'مقترحات', weight: FontWeight.bold, size: 20,),
                            SizedBox(width: size.width * .9,
                              ...
                              Obx(() {
                                return SingleChildScrollView(
                                  ...
                                  child: Wrap(
                                    children: add.addtionsDtoList!.map(
                                          (addition) {
                                        bool isSelected = false;
                                        if (selectedAdd.contains(addition)) {
                                          isSelected = true;
                                        }
                                        return GestureDetector(
                                          onTap: () {
                                            if (!selectedAdd.contains(
                                                addition)) {
                                              if (selectedAdd.length <
                                                  add.addtionsDtoList!.length) {
                                                selectedAdd.add(addition);
                                                // print(selectedAdd.value);
                                              }
                                            } else {
                                              selectedAdd
                                                  .removeWhere((
              ...
              SizedBox(width: size.width * .9,
                ...
                child: TextButton(
                  onPressed: () {
                    Get.toNamed(Routes.HALL_CALENDER,arguments: [controller.hall,selectedAdd.value]);
                  },
                  style: ButtonStyle(backgroundColor: MaterialStateProperty.all(
                      AppColors.appHallsRedDark)),
                  child: const TextWidget('استمرار', textColor: Colors.white,
                    weight: FontWeight.bold,
                    size: 15,),
