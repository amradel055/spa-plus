              ...
              children: [
                SizedBox(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const TextWidget("halls!.name!",weight: FontWeight.bold,textColor: AppColors.appHallsRedDark,),
                      Row(
                        children: [
                          Container(color: AppColors.appHallsRedDark,
                              child: const TextWidget("5/5",textColor: Colors.white,weight: FontWeight.bold,)),
                          const TextWidget('مراجعات 1560',weight: FontWeight.bold,)
                ...
                SizedBox(
                  height: 35,
                  child: Row(children: [
                    const  TextWidget('${AppStrings.number}:',weight: FontWeight.bold,),
                    const  TextWidget('${"halls!.name!"}',weight: FontWeight.bold,),
                ...
                SizedBox(
                  height: 35,
                  child: Row(children: [
                   const  TextWidget('${AppStrings.design}:',weight: FontWeight.bold,),
                   const  TextWidget('${"halls!.name!"}',weight: FontWeight.bold,),
                ...
                const TextWidget(AppStrings.servicesHall,weight: FontWeight.bold,textColor: AppColors.appHallsRedDark,),
                SizedBox(
                    ...
                    GridView.builder(
                      ...
                      scrollDirection: Axis.horizontal,
                      itemBuilder: (context, index) {
                        return const HallServices(image: "https://www.arabiaweddings.com/sites/default/files/articles/2020/02/wedding_venues_in_amman.png", name: "name");
                      },
                ...
                SizedBox(width: size.width*.9,
                  child: TextButton(
                    ...
                    child: const TextWidget(AppStrings.reserve,textColor: Colors.white,weight: FontWeight.bold,),
