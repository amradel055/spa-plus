    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: Theme.of(context).shadowColor, offset: const Offset(0, 0), spreadRadius: 5, blurRadius: 8)]),
              ...
              PositionedDirectional(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      IconButtonWidget(icon: Icons.remove,iconSize: 15,iconColor: Colors.white,onPressed: (){},),
                      TextWidget("1", weight: FontWeight.bold,textColor: Colors.white),
                      IconButtonWidget(icon: Icons.add,iconSize: 15,iconColor: Colors.white,onPressed: (){},),
                    ],
                  ),
                ),
              )
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const TextWidget(
                    "هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.",height: 1.5),
