...
class SpaTownCardWidget extends StatelessWidget {
  const SpaTownCardWidget({Key? key, required this.image, required this.title, required this.subtitle, required this.id}) : super(key: key);
  final String image;
  final String title ;
  final int id;
